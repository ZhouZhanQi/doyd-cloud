...
package com.doyd.core.util.json;
...
public class JsonArray implements Iterable<Object>, Serializable {
    ...
    public Integer getInteger(int pos) {
        return NumberConvertHelper.toInteger((Number) list.get(pos)).orElse(null);
    }
    ...
    public Long getLong(int pos) {
        return NumberConvertHelper.toLong((Number) list.get(pos)).orElse(null);
    }
    ...
    public Double getDouble(int pos) {
        return NumberConvertHelper.toDouble((Number) list.get(pos)).orElse(null);
    }
    ...
    public Float getFloat(int pos) {
        return NumberConvertHelper.toFloat((Number) list.get(pos)).orElse(null);
    }
