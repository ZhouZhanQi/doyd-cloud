...
public class DesUtil {
     ...
     * @return
     */
    public static Optional<String> desEncode(final String sourceStr, final String keyStr) {
        try {
            String encodeStr = Base64.getEncoder().encodeToString(desEncrypt(sourceStr.getBytes("UTF-8"), keyStr.getBytes("UTF-8")));
            return Optional.of(encodeStr);
        } catch (Exception e) {
    ...
    public static Optional<String> desDecode(final String sourceStr, final String keyStr) {
        try {
            ...
            String decodeStr =  new String(desDecrypt(result, keyStr.getBytes("UTF-8")), "UTF-8");
